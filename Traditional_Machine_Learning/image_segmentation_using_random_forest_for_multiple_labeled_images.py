...
img_path = "images/RandomForest_ImgSeg_Train_images/"
for image in os.listdir(img_path):  #iterate through each file 
    ...
    if input_img is None:
       print(f"Warning: {image} could not be read. Skipping...")
...
############################################################################    
     #Generate features and add to data frame
...
mask_path = "images/RandomForest_ImgSeg_Train_masks/"    
